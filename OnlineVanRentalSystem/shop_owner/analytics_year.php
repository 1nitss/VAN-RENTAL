...
year";
        ...
        while ($row2 = mysqli_fetch_array($result1)) {
            $chart_data1 .= "{date: " . $row2['year'] . ", revenue: " . $row2['yearly_revenue'] . "}, ";
        }
        ...
        <div class="main-content">
            ...
            <main>
                ...
                <div class="page-content">
                    ...
                    <a href="analytics.php"><button class="button-4 is-active" role="button">By Month</button></a>
                    <a href="analytics_year.php"><button class="button-4" role="button"  style="background-color: cyan;">By Year</button></a>
                    <div class="records table-responsive" style="background-color: #080710 !important;">
                        <div id='myfirstchart1' style="height: 400px; width: 100%;max-width 100%" class="tabs__content">
                        </div>
                    </div>
