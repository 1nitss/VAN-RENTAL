...
<body>
    ...
    <div class = "hero">
        <nav>
            <img src="images/RentAVan.png" alt="RentAvan"class = "logo">
            <ul>
            ...
            while ($data = $dataset -> fetch_assoc()){
                ...
                <div class='product-grid'>
                    <div class='product-image'>
                        <a href='favorite.php?vanId=".$data['van_no']."' class='image'>
                            <img src='images/19MBSprinter.png'>
                        </a>
                        
                        <ul class='product-links'>
                            <li><a href='#'><i class='fa-solid fa-star' style = 'color: green;'></i></a></li>
                        </ul>
                        <a href='' class='add-to-cart'>Rent Now</a>
                    </div>
